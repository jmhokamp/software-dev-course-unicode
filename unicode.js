...
let swappedString = inputString2.charAt(inputString2.length - 1) +
inputString2.charAt(1) +
inputString2.charAt(2) +
inputString2.charAt(3) +
inputString2.charAt(4) +
inputString2.charAt(0); // Your code here
